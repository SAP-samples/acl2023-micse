...
from model.models import RobertaForCL, BertForCL
...
class ModelArguments:
    ...
    style: str = field(
        default="SimCSE",
        metadata={
            "help": "What kind of pooler to use (SimCSE, miCSE)."
        }
    )

    diag_only: bool = field(
        default=False,
        metadata={
            "help": "Whether to make SimCSE loss diagonal only."
        }
    )
    ...
    hidden_dropout_prob: float = field(
        default=0.1,
        metadata={"help": "Droplayer rate, e.g. 0.1 = 10%"}
    )
...
class OurTrainingArguments(TrainingArguments):
    ...
    delete_model: bool = field(
        default=False,
        metadata={
            "help": "Whether to use delete model on exit."
        }
    )
...
def main():
    ...
    config.task_gamma = model_args.task_gamma
    ...
    # config.attention_probs_dropout_prob_reference = model_args.hidden_dropout_prob_reference
    config.hidden_dropout_prob = model_args.hidden_dropout_prob
    config.attention_probs_dropout_prob = model_args.attention_probs_dropout_prob
    config.multi_dropout = model_args.multi_dropout
    ...
    if training_args.do_train:
        ...
        #except:
        #    logger.warning("Error occured while training ...")
            
   
        # print("Error running training - removing folder: "+training_args.output_dir)
